...
void MonsterFightView::initLayer()
{
...
void MonsterFightView::fightAction()
{
...
CCFiniteTimeAction * MonsterFightView::createSequece(unsigned int action_id)
{
    ...
    switch (action_id) {
        case 1:
        {
            ...
            pAction = CCSequence::create(move1,move2,move3,CCCallFunc::create(this, callfunc_selector(MonsterFightView::playAction)),NULL);
        ...
        case 2:
        {
            ...
            pAction = CCSequence::create(scale1,scale2,CCCallFunc::create(this, callfunc_selector(MonsterFightView::playAction)),NULL);
            
        }
        case 3:
        {
            CCFadeIn *fade1 = CCFadeIn::create(ACTION_INTERVAL_TIME);
            pAction = CCSequence::create(fade1,CCCallFunc::create(this, callfunc_selector(MonsterFightView::playAction)),NULL);
...
void MonsterFightView::playAction()
{
